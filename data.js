...
window.LOOT_TABLE = {
  common: [
    ...
    { name: "Half-Drunk Mineral Water",             flavor: "+5 HYDRATION · Du kommer behöva den här." },
    { name: "Receipt from the Merchant Quarter",    flavor: "Vintage 2026. Oläsbara tecken." },
    { name: "Pocket Lint of Forgotten Memories",    flavor: "Du hade något att säga. Det är borta nu." },
    { name: "Stray Snack Wrapper",                  flavor: "+2 SHAME · Du delade inte med dig." },
  ...
  rare: [
    ...
    { name: "Raid Leader's Approving Nod",          flavor: "+15 CHA · Sällsynt. Slösa inte." },
    { name: "Shot Glass of Courage",                flavor: "+20 STR · Engångsanvändning. Aktiveras vid förtäring." },
    { name: "Guild Patch (Unstitched)",             flavor: "+8 till allt. Måste sys fast. Av Jonna." },
    { name: "Wedding Playlist Draft v3",            flavor: "+12 MEM · Låt 7 får dig att gråta. Du vet vilken." },
  ...
  epic: [
    ...
    { name: "Ring-Bearer's Burden",                  flavor: "+30 WIS · Tungt i fickan. Tyngre i själen." },
    { name: "Toastmaster's Blessing (Partial)",     flavor: "+20 LUCK · Stackar inte med förbannelsen." },
    { name: "Signed Permission from Jonna's Mum",   flavor: "+40 CHA · Extremt sällsynt drop. Extremt mäktig." },
  ...
  legendary: [
    ...
    { name: "Heart of the Holy Priest",              flavor: "+100 till allt. Redan givet till Jonna. Du bär bara hem det." },
    { name: "Realm-First: The Eternal Bond",         flavor: "ACHIEVEMENT-BOUND · Du är den första. Du kommer inte vara den sista." },
    { name: "Wedding Ring (Real)",                    flavor: "THE legendary. Tappa inte bort. Pantsätt inte. Ta aldrig av." },
